                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <button wire:click="openApprovalModal({{ $post->id }}, 'approved')"
                                        class="text-emerald-600 hover:text-emerald-900" title="Approve">
                                        <i class="fas fa-check"></i>
                                    </button>
                                    <button wire:click="openApprovalModal({{ $post->id }}, 'flagged')"
                                        class="text-amber-600 hover:text-amber-900" title="Flag">
                                        <i class="fas fa-flag"></i>
                                    </button>
                                    <button wire:click="openApprovalModal({{ $post->id }}, 'rejected')"
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="approval-modal-title">
                                    {{ ucfirst($approvalAction) }} Blog Post
                                </h3>
                                <div class="mt-2">
