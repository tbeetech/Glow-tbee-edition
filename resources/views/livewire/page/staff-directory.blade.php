                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="min-w-0">
                                        <h3 class="text-lg font-bold text-gray-900 truncate">
                                            <a href="{{ route('staff.show', $staff->slug) }}" class="hover:text-emerald-700">
                                                {{ $staff->name }}
                                            </a>
                                        </h3>
                                        <p class="text-sm text-gray-500">{{ $staff->teamRole?->name ?? ($staff->role ?? 'Staff Member') }}</p>
                                        <p class="text-xs text-emerald-600">{{ $staff->departmentRelation?->name ?? ($staff->department ?? 'General') }}</p>
                                    </div>
                                </div>
