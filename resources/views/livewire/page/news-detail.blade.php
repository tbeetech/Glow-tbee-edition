                ...
                <article class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-8 md:p-12">
                        ...
                        <div>
                            ...
                            @else
                            <div class="mb-8 p-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl text-center border-2 border-emerald-200">
                                <i class="fas fa-lock text-4xl text-emerald-600 mb-3"></i>
                                <p class="text-gray-700 mb-4">Login to join the conversation</p>
                                <a href="{{ route('login') }}" class="inline-block px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-colors">
                                    Login to Comment
                                </a>
                            </div>
                            @endauth
